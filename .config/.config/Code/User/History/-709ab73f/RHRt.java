...
{ 
    ...
    int BAR_HEIGHT = 40; // Height of the top bar
    ...
    public topBar(ChessboardGUI frame) {
        setPrefferedSize(frame.FRAME_SIZE.width, BAR_HEIGHT);                 //(new Dimension(400, 30));
    ...
    {
        backButton.setPrefferedSize(BUTTON_SIZE, BUTTON_SIZE);             //(new Dimension(30, 30));
        settingsButton.setPrefferedSize(BUTTON_SIZE, BUTTON_SIZE);             //(new Dimension(30, 30));
    ...
    public void init_spacer_panel()
    {
        ...
        SPACER_PANEL.setPrefferedSize(260, 0);
