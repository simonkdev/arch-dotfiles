...
{ 
    ...
    public topBar(ChessboardGUI frame) {
        setPreferredSize(frame.FRAME_SIZE.width, BAR_HEIGHT);                 //(new Dimension(400, 30));
    ...
    {
        backButton.setPreferredSize(BUTTON_SIZE, BUTTON_SIZE);             //(new Dimension(30, 30));
        settingsButton.setPreferredSize(BUTTON_SIZE, BUTTON_SIZE);             //(new Dimension(30, 30));
    ...
    public void init_spacer_panel()
    {
        ...
        SPACER_PANEL.setPreferredSize(260, 0);
