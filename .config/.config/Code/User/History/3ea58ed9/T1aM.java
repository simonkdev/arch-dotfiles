...
public class bottomBar extends JPanel
{
    ...
    {
        setPrefferedSize(frame.FRAME_SIZE.width, BAR_HEIGHT);
    ...
    public void load_buttons_bar()
    {
        ...
        ABORT_BUTTON.setPrefferedSize(BUTTON_WIDTH, BAR_HEIGHT);
        UNDO_BUTTON.setPrefferedSize(BUTTON_WIDTH, BAR_HEIGHT);
