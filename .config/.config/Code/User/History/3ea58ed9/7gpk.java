...
public class bottomBar extends JPanel
{
    ...
    {
        setPreferredSize(frame.FRAME_SIZE.width, BAR_HEIGHT);
    ...
    public void load_buttons_bar()
    {
        ...
        ABORT_BUTTON.setPreferredSize(BUTTON_WIDTH, BAR_HEIGHT);
        UNDO_BUTTON.setPreferredSize(BUTTON_WIDTH, BAR_HEIGHT);
