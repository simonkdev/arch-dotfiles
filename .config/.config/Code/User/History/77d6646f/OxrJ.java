...
public class chessButton extends JButton
{
    ...
    {        					// Convert column letter to number (0-based), meaning a=0, b=1, c=2, ...
        intY = Character.getNumericValue(posX.charAt(0)) - 10; // Convert column letter to number (0-based), meaning a=0, b=1, c=2, ...
        System.out.println("Converted intX: " + intX); // Debugging output to check the conversion
        intX = Character.getNumericValue(posY.charAt(0)) - 1; 	
