...
public class chessButton extends JButton
{
    ...
    {        					// Convert column letter to number (0-based), meaning a=0, b=1, c=2, ...
        intX = Character.getNumericValue(posY.charAt(0) - 'a'); // Convert column letter to number (0-based), meaning a=0, b=1, c=2, ...
        intY = Character.getNumericValue(posX.charAt(0)) - 1; 	
